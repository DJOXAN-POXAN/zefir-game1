...
const RULES_HTML = `
  ...
  <ol>
    ...
    <li><b>Звёздная битва</b> — команды выбирают действия: атаку, разведку или восстановление.</li>
  </ol>
  <h3>Модули корабля (макс. уровень 5)</h3>
  <table>
    <tr><th>Модуль</th><th>Что даёт</th></tr>
    <tr><td>Атака</td><td>Урон = уровень атаки − уровень защиты цели. <b>Если атака равна защите, есть 60% шанс нанести 1 урон.</b></td></tr>
    ...
    <tr><td>Энергия</td><td>На уровне 3: второе действие в битве. На уровне 5: +10 монет в начале каждого раунда <b>и единоразовый бонус 300 монет при достижении 5 уровня</b>.</td></tr>
    <tr><td>Тактика</td><td>На уровне 3: вы можете выбрать модуль цели при атаке (вместо случайного). На уровне 5: <b>скидка 70%</b> на все разовые услуги.</td></tr>
  </table>
  ...
  <table>
    ...
    <tr><td>Разведка</td><td><b>10 монет (один раз за раунд)</b></td><td>Полностью раскрывает корабль цели до конца раунда.</td></tr>
  ...
  <p class="muted">Атака и восстановление — общий пул из 1 действия за раунд (больше — от Энергии 3+ и купленного Двойного хода). Разведка не расходует этот пул, но доступна только один раз за раунд. После использования действия кнопка блокируется до следующего раунда.</p>
`;
